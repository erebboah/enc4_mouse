...
4. [step4_submit_data.sh](https://github.com/erebboah/enc4_mouse/blob/master/snrna/scripts/step4_submit_data.sh) runs followup script [Submission_files.R](https://github.com/erebboah/enc4_mouse/blob/master/snrna/scripts/Submission_files.R) to output files for submission to Synapse/ENCODE portal using [these guidelines](https://docs.google.com/document/d/1NAuihlO3Qd4y588Fpv1iWTyO2jxo2u8M9U-vfwnGbmE/edit#).
